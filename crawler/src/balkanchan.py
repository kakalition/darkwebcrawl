...
class DarkwebCrawler(BaseCrawler):
    base_url = "http://26yukmkrhmhfg6alc56oexe7bcrokv4rilwpfwgh2u6bsbkddu55h4ad.onion"
    ...
    def _scrape_post(self, post, i):
        try:
            ...
            timestamp_text = post.find('span', class_="labelCreated")  
            if timestamp_text:
            ...
            # Add base_url to media href if media exists
            media_url = f"{self.base_url}{media['href']}" if media and media.has_attr("href") else None
            ...
            return DarkPost(
                ...
                post_media=media_url,  # Now using the modified media_url with base_url
                post_id=post_id,
                is_op=is_op,
            )
